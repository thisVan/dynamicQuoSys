...
//	}
	...
	public static final OrderAuditOperType ADD = new OrderAuditOperType(new Character('A'));
	public static final OrderAuditOperType ALTER = new OrderAuditOperType(new Character('L'));
	public static final OrderAuditOperType DELETE = new OrderAuditOperType(new Character('D'));
	
	public static OrderAuditOperType getInstanceBySymbol(Character symbol){
		OrderAuditOperType result = (OrderAuditOperType) instancesBySymbol.get(symbol);
		if(result == null){
