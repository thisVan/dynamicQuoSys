...
/**
 * 
 * 项目名称：dynamic-quote-system 
 * 类全名:com.nfledmedia.dynamicquotesystem.GetDayList 
 * 类描述：获取时间序列，作为前端界面中图表的时间轴
 * 创建人：Van@nfledmedia 
 * 创建时间：2016年5月30日 上午10:52:42 
 * 修改备注： 
 * @version  jdk1.7 
 * 
...
public class GetDayList {
	...
	/**
	 * 
	 * getProccedDate:返回处理过的时间序列，这个时间序列形如 31,2016年，2,3,...,31,2月,2... 
	 * TODO 在方法getDay()之后进行处理
	 * @author Wu. Van 
	 * @param date
	 * @return 
	 * @since JDK 1.6
