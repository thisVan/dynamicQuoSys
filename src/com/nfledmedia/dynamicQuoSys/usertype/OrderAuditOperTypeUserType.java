...
/**
 * BrandAuditOperType对应的hibernate映射类型
 */
public class OrderAuditOperTypeUserType extends EnumUserTypeSupport<OrderAuditOperType> {
	...
	public Object nullSafeGet(ResultSet arg0, String[] arg1, Object arg2)
		...
		try {
			return OrderAuditOperType.getInstanceBySymbol(symbol);
		} catch (NoSuchElementException e) {
			throw new HibernateException("Bad BrandAuditOperType value: "+symbol, e);
		}
	}
	...
	public void nullSafeSet(PreparedStatement arg0, Object arg1, int arg2)
		...
		if(arg1 != null){
			symbol = ((OrderAuditOperType)arg1).getSymbol();
		}
