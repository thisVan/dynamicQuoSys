...
public class MessageService {
	...
	private void setMessageRead(Long id){
		...
		System.out.println("MessageService中获取的mesaage的getId："+message.getId());
		System.out.println("MessageService中获取的mesaage的hasRead修改前："+message.getHasRead());
		if(message.getHasRead()!=1){
			message.setHasRead(1);
			messageDAO.merge(message);
		}
		System.out.println("MessageService中获取的mesaage的hasRead修改后："+message.getHasRead());
	}
